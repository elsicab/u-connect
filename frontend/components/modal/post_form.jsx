...
class PostForm extends React.Component{
    ...
    render(){   
        ...
        const avatarPost = this.props.currentUser.avatarUrl ? <img className= "avatar_post" src={this.props.currentUser.avatarUrl} /> : <img className="avatar_post" src={window.avatar} />;
